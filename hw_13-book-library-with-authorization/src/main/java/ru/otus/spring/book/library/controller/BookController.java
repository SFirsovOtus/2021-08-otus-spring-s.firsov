...
public class BookController {
    ...
    @GetMapping(URL_ROOT)
    public String getBooksWhenGetRequestOfRoot() {
        return "redirect:" + URL_BOOKS;
    }

    @PostMapping(URL_ROOT)
    public String getBooksWhenPostRequestOfRoot() {
        return "redirect:" + URL_BOOKS;
    }
    ...
    public String deleteBook(@RequestParam(PARAM_BOOK_ID) long bookId, Model model) {
