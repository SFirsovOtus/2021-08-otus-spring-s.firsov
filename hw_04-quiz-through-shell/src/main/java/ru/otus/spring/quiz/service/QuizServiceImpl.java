...
public class QuizServiceImpl implements QuizService {
    ...
    @Override
    public String reportThatNeedToIntroduceYourself() {
        String message = localizationIOService.getMessage("quiz.introduce-yourself");
        localizationIOService.print(System.lineSeparator());
        localizationIOService.print(message);
        return message;
    }

    @Override
    public String reportThatAlreadyIntroducedYourself(Student student) {
        String message = localizationIOService.getMessage("quiz.already-introduced-yourself", studentMapper.mapToStringWithNameSurnameOrder(student));
        localizationIOService.print(System.lineSeparator());
        localizationIOService.print(message);
        return message;
    }
    ...
    @Override
    public void conductQuiz(Student student) {
