...
create table users(id bigint generated by default as identity primary key, name varchar(255) not null, password varchar(255) not null, role varchar(255) not null);
